...
if(isset($_GET['submit'])){
    ...
    $filhote_do_boi = filter_input(INPUT_GET, "boi");
    $filhote_da_vaca = filter_input(INPUT_GET, "vaca");
...
//inserindo na tabela natalidades
$sql2 = mysqli_query($conexao, "INSERT INTO natalidades(identificacao_natalidade, filho_da_vaca, filho_do_boi)VALUES('$identificacao','$filhote_da_vaca','$filhote_do_boi')");
...
<div style="background-color: rgb(91, 129, 93)">
    ...
    <main>
    <h2>Dados do Nascimento</h2>
    <form action="natalidade.php" method="get">
    ...
    <div class="form-floating mb-3">
    <input type="text" name="boi" id="nome" autocomplete="off" maxlength = "30" required class="form-control" id="floatingInput" placeholder="Filhote do Boi">
    <label for="floatingInput">Filhote do Boi</label>
    </div>

    <div class="form-floating mb-3">
    <input type="text" name="vaca" id="nome" autocomplete="off" maxlength = "30" required class="form-control" id="floatingInput" placeholder="Filhote do Vaca">
    <label for="floatingInput">Filhote da Vaca</label>
    </div>
